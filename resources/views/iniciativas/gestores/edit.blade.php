@extends('app')
@section('content')
    {!! Breadcrumbs::render('gestorEdit') !!}
    <div class="row">
        <div class="col-sm-12">
            <legend><i class="glyphicon glyphicon-edit"></i> Editar Gestror de Iniciativa</legend>
        </div>
    </div>
    ...
    <div class="row" id="gestor">
        ...
        <div class="col-sm-12">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-6">
                        <button class="btn btn-success" type="submit" v-on:click="salvarGestor($event)"><span class="glyphicon glyphicon-save"></span> Salvar</button>
                    </div>
